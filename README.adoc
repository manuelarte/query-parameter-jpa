...
=== Entity Query Parameter Validation Annotation

It's also possible to validate the query parameters to be queried at an entity level.

==== @QueryParamNotNull

By annotating your field with @QueryParamNotNull it will be checked that the key is present.

==== @QueryParamNull

By annotating your field with @QueryParamNull it will be checked that the key is not present.
